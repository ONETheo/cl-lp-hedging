...
def main():
    ...
    for name, result in results:
        if result['il_reduction'] > best_reduction and name != "Baseline":
    ...
    print("""
• Concentrated 1% ranges have extreme IL (64% in 26 days)
• Optimal hedging reduces IL by ~27% (relative)
• Asymmetric thresholds (45/58) outperform symmetric (50/50)
• Tight stops (8 ticks) beat wider stops despite lower win rate
• Even with hedging, need ~46% APY fees to break even
""")
